...
const SLIDES = [
  {
    ...
    html: `
      ...
      <p class="assinatura">Cauê Lima e trio · Turma 3001 · Martha Falcão Wyden</p>`
  },
  {
    tema: "claro",
  ...
  },
  {
    ...
    html: `
      ...
      <p class="assinatura">Obrigado! · Classificação e Descarte · Introdução à Segurança da Informação</p>`
  }
];
